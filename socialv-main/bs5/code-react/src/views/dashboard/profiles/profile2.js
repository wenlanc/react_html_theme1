                ...
                <Col lg="12">
                        ...
                        <Card.Body>
                            <div className="grid-container">
                                <div className="item1 ms-1">
                                    <img src={imgp1} className="img-fluid rounded profile-image" alt="profile-img"/>
                                </div>
                                ...
                                <div className="item6 border-light border-end border-start">
                                    ...
                                    <div className="iq-media-group ms-1">
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle" src={imgp2} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle" src={imgp3} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle" src={imgp4} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle" src={imgp5} alt=""/>
                                        </Link>
                                    </div>                              
                                </div>
                    ...
                    <Card className="card-header-2">
                        <Card.Body className="text-center">
                            <div className="mb-2">
                                <img src={imgp6} className="img-fluid rounded profile-image" alt="profile-img"/>
                            </div>
                            <div className="mb-2">
                            ...
                            <hr/>
                              <div className="mb-2">
                                    ...
                                    <div className="iq-media-group ms-1">
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle" src={imgp7} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle" src={imgp8} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle" src={imgp9} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle" src={imgp10} alt=""/>
                                        </Link>
                                    </div>                              
                                </div>
                                <hr/>
                    ...
                    <Card className="card-header-3">
                        <Card.Body>
                            <div className="mb-2 text-center">
                                <img src={imgp11} className="img-fluid rounded profile-image" alt="profile-img"/>
                            </div>
                            ...
                            <div className="d-flex justify-content-between">
                                ...
                                <div className="item6 border-light border-end border-start">
                                    ...
                                    <div className="iq-media-group ms-1">
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle card-text-1" src={imgp12} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle card-text-1" src={imgp13} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle card-text-1" src={imgp13} alt=""/>
                                        </Link>
                                        <Link to="#" className="iq-media">
                                            <img className="img-fluid avatar-40 rounded-circle card-text-1" src={imgp14} alt=""/>
                                        </Link>
                                    </div>                              
                                </div>
                                <div className="item7 ms-2">
                    ...
                    <Card>
                        ...
                        <Card>
                            <div className="d-grid gap-2 grid-cols-3">
                                {/* {{!-- <Link> --}} */}
                                    <img src={imgp15} className="img-fluid bg-soft-info rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}} */}
                                {/* {{!-- <Link> --}} */}
                                    <img src={imgp16} className="img-fluid bg-soft-primary rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}} */}
                                {/* {{!-- <Link> --}} */}
                                    <img src={imgp17} className="img-fluid bg-soft-info rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}} */}
                                {/* {{!-- <Link> --}} */}
                                    <img src={imgp18} className="img-fluid bg-soft-primary rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}}
                                {{!-- <Link> --}} */}
                                    <img src={imgp19} className="img-fluid bg-soft-warning rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}}
                                {{!-- <Link> --}} */}
                                    <img src={imgp20} className="img-fluid bg-soft-primary rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}}
                                {{!-- <Link> --}} */}
                                    <img src={imgp21} className="img-fluid bg-soft-danger rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}}
                                {{!-- <Link> --}} */}
                                    <img src={imgp22} className="img-fluid bg-soft-primary rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}}
                                {{!-- <Link> --}} */}
                                    <img src={imgp23} className="img-fluid bg-soft-success rounded img-size" alt="profile-img"/>
                                {/* {{!-- </Link> --}} */}
                            </div>
                        </Card>
                    </Card>
                                ...
                                <li className="">
                                    <div className="d-flex justify-content-between">
                                        <div className="user-img">
                                            <img src={imgp24} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid"/>
                                        </div>
                                        <div className="w-100">                
                                            ...
                                            <div className="d-flex justify-content-between">
                                                ...
                                                <div>
                                                    <div className="d-flex align-items-center">
                                                        <svg fill="none" width="18px" stroke="currentColor" className="me-2" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M14.828 14.828a4 4 0 01-5.656 0M9 10h.01M15 10h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                        ...
                        <Card.Body>
                            <ul className="post-comments p-0 m-0">
                                <li className="">
                                    <div className="d-flex justify-content-between">
                                        <div className="user-img">
                                            <img src={imgp25} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid"/>
                                        </div>
                                        <div className="w-100">                
                                            <form className="post-text mt-2">
                                                <input type="text" className="form-control rounded" placeholder="Write something here..." style={{border: "none"}}/>                      
                        ...
                        <Card.Body>
                            <ul className="post-comments p-0 m-0">
                                <li className="mb-2">
                                    <div className="d-flex justify-content-between">
                                        <div className="user-img">
                                            <img src={imgp26} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid"/>
                                        </div>
                                        <div className="w-100 text-margin">    
                                                ...
                                                {/* {{!-- <div className="like-block position-relative d-flex align-items-center"> --}} */}
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        <div className="d-flex align-items-center me-1">
                                                            <svg width="18px" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M4.318 6.318a4.5 4.5 0 000 6.364L12 20.364l7.682-7.682a4.5 4.5 0 00-6.364-6.364L12 7.636l-1.318-1.318a4.5 4.5 0 00-6.364 0z"></path></svg>
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        {/* {{!-- <div className=""> --}} */}
                                                            ...
                                                            {/* {{!-- <div className="iq-media-group"> --}} */}
                                                                <Link to="#" className="iq-media ">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp27} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media ">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp28} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media ">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp29} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media ">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp30} alt=""/>
                                                                </Link>
                                                            {/* {{!-- </div>                               --}} */}
                                                        {/* {{!-- </div> --}} */}
                                                    </div>
                                           ...
                                           <form className="d-flex align-items-center mt-3" action="#">
                                                ...
                                                <div className="comment-attagement d-flex align-items-center me-4">
                                                    <svg width="18px" className="me-1 card-text-1" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.512 15.042 3 13.574 3 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"></path></svg>
                        ...
                        <Card.Body>
                            <ul className="post-comments p-0 m-0">
                                <li className="mb-2">
                                    <div className="d-flex justify-content-between">
                                        <div className="user-img">
                                            <img src={imgp31} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid"/>
                                        </div>
                                        <div className="w-100 text-margin">    
                                            <h4>Mathilda Gvarliana</h4>
                                            <h5 className="mb-0">March 14, 23:00</h5>
                                                ...
                                                {/* {{!-- <div className="like-block position-relative d-flex align-items-center"> --}} */}
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        {/* {{!-- <div className=""> --}} */}
                                                            ...
                                                            {/* {{!-- <div className="iq-media-group"> --}} */}
                                                                <Link to="#" className="iq-media">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp32} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp33} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp34} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp35} alt=""/>
                                                                </Link>
                                                            {/* {{!-- </div>                               --}} */}
                                                        {/* {{!-- </div> --}} */}
                                                    </div>
                        ...
                        <Card.Body>
                            <ul className="post-comments p-0 m-0">
                                <li className="mb-2">
                                     <div className="d-flex justify-content-between">
                                        <div className="user-img">
                                            <img src={imgp36} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid"/>
                                        </div>
                                        <div className="w-100 text-margin">    
                                            <h4>Mathilda Gvarliana</h4>
                                            <h5 className="mb-0">March 14, 23:00</h5>
                                                ...
                                                {/* {{!-- <div className="like-block position-relative d-flex align-items-center"> --}} */}
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        {/* {{!-- <div className=""> --}} */}
                                                            ...
                                                            {/* {{!-- <div className="iq-media-group"> --}} */}
                                                                <Link to="#" className="iq-media">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp37} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp38} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp39} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp40} alt=""/>
                                                                </Link>
                                                            {/* {{!-- </div>                               --}} */}
                                                        {/* {{!-- </div> --}} */}
                                                    </div>
                                           ...
                                           <div className="text-center mt-4">
                                            ...
                                            <ul className="post-comments p-2 m-0 bg-soft-light text-dark">
                                                <li className="mb-2">
                                                    <div className="d-flex justify-content-between">
                                                        <div className="user-img">
                                                            <img src={imgp41} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid"/>
                                                        </div>
                                                        <div className="w-100 text-margin">    
                                                           <div className="">
                                            ...
                                            <ul className="post-comments p-2 m-0 bg-soft-light text-dark">
                                                <li className="mb-2">
                                                    <div className="d-flex justify-content-between">
                                                        <div className="user-img">
                                                            <img src={imgp42} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid"/>
                                                        </div>
                                                        <div className="w-100 text-margin">    
                                                           <div className="">
                                                                <h5 className="mb-0 d-inline-block me-1">Emma Labelle</h5>
                                                            ...
                                                            <ul className="post-comments p-0 mt-4 text-dark">
                                                                <li className="mb-2">
                                                                    <div className="d-flex justify-content-between">
                                                                        <div className="user-img">
                                                                            <img src={imgp43} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid avatar-1"/>
                                                                        </div>
                                                                        <div className="w-100 text-margin">    
                                                                        <div className="">
                                                                                <h5 className="mb-0 d-inline-block me-1">Emma Labelle</h5>
                                                            ...
                                                            <ul className="post-comments p-0 mt-4 text-dark">
                                                                <li className="mb-2">
                                                                    <div className="d-flex justify-content-between">
                                                                        <div className="user-img">
                                                                            <img src={imgp44} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid avatar-1"/>
                                                                        </div>
                                                                        <div className="w-100 text-margin">    
                                                                        <div className="">
                                                                                <h5 className="mb-0 d-inline-block me-1">Emma Labelle</h5>
                        ...
                        <Card.Body>
                            <ul className="post-comments p-0 m-0">
                                <li className="mb-2">
                                    <div className="d-flex justify-content-between">
                                        <div className="user-img">
                                            <img src={imgp46} alt="userimg" className="avatar-60 me-3 rounded-circle img-fluid"/>
                                        </div>
                                        <div className="w-100 text-margin">    
                                            <h4>Mathilda Gvarliana</h4>
                                            ...
                                            <div className="d-grid gap-2 grid-cols-2 mb-2">
                                               <Link to="#"> 
                                                    <img src={imgp47} className="img-fluid bg-soft-info rounded sub-image image-size" alt="profile-img"/>
                                                </Link> 
                                               <Link to="#"> 
                                                    <img src={imgp48} className="img-fluid bg-soft-primary rounded sub-image image-size" alt="profile-img"/>
                                                </Link> 
                                               <Link to="#"> 
                                                    <img src={imgp49} className="img-fluid bg-soft-info rounded sub-image image-size" alt="profile-img"/>
                                                </Link> 
                                               <Link to="#"> 
                                                    <img src={imgp50} className="img-fluid bg-soft-primary rounded sub-image image-size" alt="profile-img"/>
                                                </Link> 
                                            </div>
                                                 ...
                                                 <span className="card-text-2">
                                                    ...
                                                    <div className="d-flex justify-content-between align-items-center">
                                                        {/* {{!-- <div className=""> --}} */}
                                                            ...
                                                            {/* {{!-- <div className="iq-media-group"> --}} */}
                                                                <Link to="#" className="iq-media ">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp51} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media ">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp52} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media ">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp53} alt=""/>
                                                                </Link>
                                                                <Link to="#" className="iq-media ">
                                                                <img className="img-fluid item-img rounded-circle card-text-1" src={imgp54} alt=""/>
                                                                </Link>
                                                            {/* {{!-- </div>                               --}} */}
                                                        {/* {{!-- </div> --}} */}
                                                    </div>
