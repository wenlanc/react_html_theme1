                ...
                <div class="col-lg-12">
                    <div class="d-flex align-items-center justify-content-between mb-3 flex-wrap">
                        <div class="group-info d-flex align-items-center">
                            <div class="me-3">
                                <img class="rounded-circle img-fluid avatar-100" src="{{asset('images/page-img/gi-1.jpg')}}" alt="">
                            </div>
                            <div class="info">
                                <h4>Developer's...</h4>
                        ...
                        <div class="group-member d-flex align-items-center  mt-md-0 mt-2">
                            <div class="iq-media-group me-3">
                                ...
                                <a href="#" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="{{asset('images/user/11.jpg')}}" alt="">
                                </a>
                                <a href="#" class="iq-media">
                                <img class="img-fluid avatar-40 rounded-circle" src="{{asset('images/user/12.jpg')}}" alt="">
                                </a>
                            </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="post-item">
                                ...
                                <div class="user-post">
                                    <a href="javascript:void();"><img src="{{asset('images/page-img/52.jpg')}}" alt="post-image" class="img-fluid w-100" /></a>
                                </div>
                            ...
                            <div class="post-item">
                                ...
                                <div class="user-post">
                                    <a href="javascript:void();"><img src="{{asset('images/page-img/60.jpg')}}" alt="post-image" class="img-fluid w-100" /></a>
                                </div>
                                <div class="comment-area mt-3">
                                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                                        <div class="like-block position-relative d-flex align-items-center">
