                        ...
                        <div id="post-modal-data" class="card">
                           ...
                           <div class="card-body" data-toggle="modal" data-target="#post-modal">
                              ...
                              <ul class="post-opt-block d-flex align-items-center list-inline m-0 p-0">
                                 <li class="rounded p-2 pointer me-3"><a href="#"></a><img src="{{asset('images/small/07.png')}}" alt="icon" class="img-fluid"> Photo/Video</li>
                                 <li class="rounded p-2 pointer me-3"><a href="#"></a><img src="{{asset('images/small/08.png')}}" alt="icon" class="img-fluid"> Tag Friend</li>
                                 <li class="rounded p-2 pointer me-3"><a href="#"></a><img src="{{asset('images/small/09.png')}}" alt="icon" class="img-fluid"> Feeling/Activity</li>
                                    ...
                                    <div class="modal-body">
                                       ...
                                       <ul class="d-flex flex-wrap align-items-center list-inline m-0 p-0">
                                          <li class="col-md-6 mb-3">
                                             <div class="bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="{{asset('images/small/07.png')}}" alt="icon" class="img-fluid"> Photo/Video</div>
                                          </li>
                                          <li class="col-md-6 mb-3">
                                             <div class="bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="{{asset('images/small/08.png')}}" alt="icon" class="img-fluid"> Tag Friend</div>
                                          </li>
                                          <li class="col-md-6 mb-3">
                                             <div class="bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="{{asset('images/small/09.png')}}" alt="icon" class="img-fluid"> Feeling/Activity</div>
                                          </li>
                                          <li class="col-md-6 mb-3">
                                             <div class="bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="{{asset('images/small/10.png')}}" alt="icon" class="img-fluid"> Check in</div>
                                          </li>
                                          <li class="col-md-6 mb-3">
                                             <div class="bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="{{asset('images/small/11.png')}}" alt="icon" class="img-fluid"> Live Video</div>
                                          </li>
                                          <li class="col-md-6 mb-3">
                                             <div class="bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="{{asset('images/small/12.png')}}" alt="icon" class="img-fluid"> Gif</div>
                                          </li>
                                          <li class="col-md-6 mb-3">
                                             <div class="bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="{{asset('images/small/13.png')}}" alt="icon" class="img-fluid"> Watch Party</div>
                                          </li>
                                          <li class="col-md-6 mb-3">
                                             <div class="bg-primary rounded p-2 pointer mr-3"><a href="#"></a><img src="{{asset('images/small/14.png')}}" alt="icon" class="img-fluid"> Play with Friends</div>
                                          </li>
                                       </ul>
                                       <hr>
