        ...
        <nav class="navbar navbar-expand-lg navbar-light p-0">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav  ms-auto navbar-list">
                    <li>
                        <a href="{{route('newsfeed')}}" class="  d-flex align-items-center">
                    ...
                    <li class="nav-item dropdown">
                     ...
                     <li class="nav-item dropdown">
                        <a href="#" class="   d-flex align-items-center dropdown-toggle" id="drop-down-arrow" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                            <img src="{{asset('images/user/1.jpg')}}" class="img-fluid rounded-circle me-3" alt="user">
                            <div class="caption">
                        ...
                        <div class="sub-drop dropdown-menu caption-menu" aria-labelledby="drop-down-arrow">
                            <div class="card shadow-none m-0">
                                ...
                                <div class="card-body p-0 ">
                                    ...
                                    <a href="{{route('profileedit')}}" class="iq-sub-card iq-bg-warning-hover">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{route('accountsetting')}}" class="iq-sub-card bg-soft-info-hover">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <a href="{{route('privacysetting')}}" class="iq-sub-card iq-bg-danger-hover">
                                        <div class="d-flex align-items-center">
                                    ...
                                    <div class="d-inline-block w-100 text-center p-3">
                                        <a class="btn btn-primary iq-sign-btn" href="{{route('signin')}}" role="button">Sign
