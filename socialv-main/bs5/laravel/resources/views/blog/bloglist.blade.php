                                 ...
                                 <div class="blog-description p-2">
                                    ...
                                    <div class="group-smile mt-4 d-flex flex-wrap align-items-center justify-content-between position-right-side">
                                       <div class="iq-media-group">
                                          ...
                                          <img class="img-fluid rounded-circle" src="{{asset('images/icon/01.png')}}" alt="">
                                          </a>
                                          <a href="#" class="iq-media">
                                          <img class="img-fluid rounded-circle" src="{{asset('images/icon/02.png')}}" alt="">
                                          </a>
                                          <a href="#" class="iq-media">
                                          <img class="img-fluid rounded-circle" src="{{asset('images/icon/03.png')}}" alt="">
                                          </a>
                                          <a href="#" class="iq-media">
                                          <img class="img-fluid rounded-circle" src="{{asset('images/icon/07.png')}}" alt="">
                                          </a>
                                       </div>                                 
                     ...
                     <div class="card card-block card-stretch card-height blog-list list-even">
                        <div class="card-body">
                           <div class="row align-items-center">
                              ...
                              <div class="col-md-6">
                                 <div class="image-block">
                                    <img src="{{asset('images/blog/02.jpg')}}" class="img-fluid rounded w-100" alt="blog-img">
                                 </div>
                              </div>
                           </div>
                        </div>
