            ...
            <div class="col-sm-12 col-lg-6">
               ...
               <div class="card">
                  ...
                  <div class="card-body">
                     ...
                     <!-- Extra large modal -->
                     <button type="button" class="btn btn-primary mt-1" data-bs-toggle="modal" data-bs-target=".bd-example-modal-xl">Extra large modal</button>
                     ...
                     <!-- Large modal -->
                     <button type="button" class="btn btn-primary mt-1" data-bs-toggle="modal" data-bs-target=".bd-example-modal-lg">Large modal</button>
                     ...
                     <!-- Small modal -->
                     <button type="button" class="btn btn-primary mt-1" data-bs-toggle="modal" data-bs-target=".bd-example-modal-sm">Small modal</button>
