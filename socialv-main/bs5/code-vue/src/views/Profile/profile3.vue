            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <ul class="post-opt-block d-flex list-inline m-0 p-0 flex-wrap justify-content-around">
                        ...
                        <li class="bg-soft-primary rounded p-2 pointer d-flex align-items-center me-3 mb-md-0 mb-2"><img src="@/assets/images/small/08.png" alt="icon" class="img-fluid me-2"> Live Video </li>
                        <li class="bg-soft-primary rounded p-2 pointer d-flex align-items-center me-3"><img src="@/assets/images/small/09.png" alt="icon" class="img-fluid me-2"> Life Events</li>
                    </ul>
                </div>
            </div>
            <div class="card">
