            ...
            <div class="card-body">
               ...
               <div class="blog-description mt-3">
                  ...
                  <div class="blog-meta d-flex align-items-center mb-3">
                     <div class="date me-4"><i class="ri-calendar-2-fill text-primary pe-2"></i>2 Weeks ago</div>
                     <div class="like me-4"><i class="ri-thumb-up-line text-primary pe-2"></i>20 like</div>
                     <div class="comments me-4"><i class="ri-chat-3-line text-primary pe-2"></i>82 comments</div>
